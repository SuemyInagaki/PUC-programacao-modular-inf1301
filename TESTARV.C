...
*                   - chama a função ARV_InserirFolhaDireita( <Char>, <int1>, <int2>, <int3> )
*                     Obs. notação: <Char>, <int1>, <int2>, <int3>  são os valores dos parâmetros
*                     que se encontram no comando de teste.
*     "=insesq" <Char>
*                   - chama a função ARV_InserirEsquerda( <Char> )
*     "=insfolhaesq" <Char> <int1> <int2> <int3>
*                   - chama a função ARV_InserirFolhzEsquerda( <Char>, <int1>, <int2>, <int3> )
*                     Obs. notação: <Char>, <int1>, <int2>, <int3>  são os valores dos parâmetros
*                     que se encontram no comando de teste.\
*     "=costurar"   - chama a função ARV_CosturarFolhas( )
*     "=mostrarcostura"
